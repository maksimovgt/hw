...
class LotoCard:
    ...
    def __init__(self):
        ...
        uniques = self.generate_numbers(uniques_count, 1, 90)
    ...
    def __contains__(self, item):
        """
        Меняем логику IN для определения наличия в карточке чисел
        """
...
class Game:
    ...
    def __init__(self):
        self.__usercard = LotoCard()
        self.__compcard = LotoCard()
        self.__kegs = LotoCard.generate_numbers(self.__numkegs, 1, 90)
